...
let songIndex = 0;
let songs = [
  "./files/Playlist Tổng Hợp Những Bài Hát Hay Nhất Của YOASOBI.mp3",
  "./files/One Summer's Day.mp3",
  "./files/Tình Yêu Ngủ Quên.mp3",
  "./files/Dịu Dàng Em Đến.mp3",
  "./files/Lần Hẹn Hò Đầu Tiên.mp3",
];
let thumbnails = [
...
let songArtists = ["YOASOBI", "Joe Hiraisi", "Hoàng Tôn ft. LyHan", "Erik","CUKAK Remix"];
let songTitles = ["PlayList YOASOBI", "One Summer's Day", "Tình yêu ngủ quên", "Dịu dàng em đến","Lần hẹn hò đầu tiên"];
let timer;
